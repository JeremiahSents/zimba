        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex justify-between border-b pb-2">
              ...
              <span>{u.email} {u.emailVerified && "✓"}</span>
            </div>
            <div className="flex justify-between border-b pb-2">
            ...
            {u.organizationMemberships.length === 0 ? (
              ...
              <div className="space-y-4">
                {u.organizationMemberships.map(mem => (
                  <div key={mem.id} className="flex justify-between items-center border-b pb-2">
                    <span className="font-medium">{mem.organization?.name}</span>
