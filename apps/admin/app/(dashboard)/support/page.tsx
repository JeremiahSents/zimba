...
const mockSupportData = [
  {
    id: "1",
    organizationName: "BuildTech Inc",
    priority: "High",
    status: "needs_follow_up",
    lastContact: "2026-07-20",
    note: "Waiting for invoice approval",
  },
  {
    id: "2",
    organizationName: "Apex Construction",
    priority: "Medium",
    status: "watching",
    lastContact: "2026-07-15",
    note: "Monitor receipt parsing",
  },
  {
    id: "3",
    organizationName: "Skyline Developers",
    priority: "Low",
    status: "resolved",
    ...
    <div className="flex-1 p-6 lg:p-8">
      ...
      <div className="mb-6 rounded-md border border-muted-foreground/20 bg-muted/50 p-4">
        ...
        <p className="mt-2 text-muted-foreground text-sm">
          Support ticketing and internal notes schema is not yet available in
          the database. This data is mocked.
        </p>
      </div>
