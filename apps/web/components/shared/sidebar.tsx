...
export function DashboardSidebar() {
  ...
  return (
    ...
    >
      <SidebarHeader className="p-2 pb-3 group-data-[collapsible=icon]:px-0">
        <WorkspaceSwitcher />
      </SidebarHeader>

      <SidebarContent>
        <SidebarGroup className="px-1 py-1 group-data-[collapsible=icon]:px-0">
      ...
      <SidebarFooter className="p-2 pt-2 group-data-[collapsible=icon]:px-0">
        <GrantBanner />
        <UserProfileCard />
      </SidebarFooter>
    </Sidebar>
  ...
  return (
    <Menu.Root>
      ...
      >
        ...
        {/* min-w-0 on both the flex child and the spans: without it a long
            name forces the card wider than the sidebar instead of truncating. */}
