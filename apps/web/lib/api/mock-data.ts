    ...
    tasks: [
      {
        ...
        spent: Math.round(project.budget * 0.45 * 0.4),
        pct: 40,
      },
      {
        id: project.id * 10 + 2,
        ...
        spent: Math.round(project.budget * 0.3 * 0.7),
        pct: 70,
      },
      {
        id: project.id * 10 + 3,
        name: "Equipment",
        budget: Math.round(project.budget * 0.2),
        spent: Math.round(project.budget * 0.2 * 0.88),
        pct: 88,
      },
    ],
  })
