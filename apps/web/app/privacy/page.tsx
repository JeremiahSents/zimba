        ...
        <div className="mt-10 space-y-8 text-muted-foreground text-sm leading-relaxed">
          <section>
            ...
            <p className="mt-2">
              ...
              and profile photo as provided by Google. We also collect
              information you submit directly, such as project details,
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              authenticate your account, communicate with you about your
              account, and display your name and photo within the app.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              connections. We do not sell your personal information to third
              parties.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              We use Google OAuth for authentication. Your use of Google
