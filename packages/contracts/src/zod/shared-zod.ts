...
export const searchSchema = z.object({ search: z.string().trim().max(200).optional(), sortBy: z.string().trim().max(80).optional(), sortDirection: z.enum(["asc", "desc"]).default("asc") })
